...
export function InfiniteCardSlider() {
  ...
  useEffect(() => {
    async function getProducts() {
      try {
        ...
        // Filter based on your specific portal requirements
  ...
  // Track component to ensure identical cloning
  const ProductTrack = () => (
      ...
      {products.map((product, index) => {
        ...
        return (
          <div
            ...
            className="w-[280px] md:w-[350px] shrink-0 cursor-pointer mt-5 px-3 group"
          >
            {/* Image Container */}
  ...
  return (
    <section className="w-full py-10 overflow-hidden bg-transparent relative">
      {/* We use two tracks (the original and one clone). 
          The animation moves -50% (the width of exactly one set).
          This creates a frame-perfect reset.
      */}
