export function Events() {
    return (
        <section className="flex flex-col md:flex-row items-stretch mt-14 mx-6 rounded-3xl overflow-hidden border-[5px] border-white h-[clamp(413px,45.73vw+241.5px,860px)]">
